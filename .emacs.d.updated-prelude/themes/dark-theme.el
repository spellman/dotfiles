...
;;;;; font lock
   ...
   `(font-lock-keyword-face ((t (:foreground ,dark-fg :weight normal))))
...
;;;;; web-mode
   ...
   `(web-mode-html-attr-value-face ((t (:foreground ,dark-fg-025))))
   `(web-mode-html-tag-face ((t (:foreground ,dark-fg))))
   `(web-mode-html-tag-bracket-face ((t (:foreground ,dark-fg))))
